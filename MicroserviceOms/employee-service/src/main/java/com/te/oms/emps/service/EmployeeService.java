package com.te.oms.emps.service;
...
public interface EmployeeService {
	...
	FetchEmployeeDto findByEmpId(String empId);

	List<FetchEmployeeDto> findAllEmployees();

	List<Employee> findEmployeesBydeptId(int id);
